...
INSERT INTO comments VALUES ( '1', 'grex', 'grex@scouts-es.org', 'Your suggestions are welcome', 'Please, help us improving Widi. We want to know more about Open Source developers!', '20010510133952');
...
CREATE TABLE count (
   countid bigint(20) unsigned DEFAULT '0' NOT NULL auto_increment,
   number int(8) DEFAULT '0' NOT NULL,
   creation_count timestamp(14),
   UNIQUE countid (countid)
);
